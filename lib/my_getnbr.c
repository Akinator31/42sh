...
static int check_minus_and_size_number(int result, int minus, int size_nb)
{
...
static int determine_sign_number(int minus)
{
    int k = 0;
    int p;
...
static long long get_result(int size_str, char const *str, int i)
{
    int e;
    long long result = 0;
...
static void analyse_str(int **arr, char const *str, int *minus)
{
